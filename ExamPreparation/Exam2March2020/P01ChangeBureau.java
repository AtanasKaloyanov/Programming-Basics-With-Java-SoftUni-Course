...
public class P01ChangeBureau {
    public static void main(String[] args) {
        ...
        // Сега ще ходи на екскурзия из Европа и ще му трябва евро. Освен биткойн има и китайски юанa.
        ...
        double numberYuans = Double.parseDouble(scanner.nextLine());
        double commission = Double.parseDouble(scanner.nextLine());

        double euro = numberBitcoins * 1168.00  / 1.95;
        double euro2 = numberYuans * 0.15 * 1.76  / 1.95;
        double totalSum = euro + euro2;
        double totalSumWithoutCommission = totalSum - totalSum * (commission / 100);
        System.out.printf("%.2f", totalSumWithoutCommission);
